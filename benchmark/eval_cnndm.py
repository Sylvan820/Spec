...
class EvalCNNDM(Decoding):
    ...
    def load_data(self):
        ...
        self.color_print(f"Loading CNNDM data...", 3)
        data = []
        with open(os.path.join(self.args.data_path, "cnndm.jsonl")) as f:
    ...
    def eval(self):
        ...
        out_path = os.path.join(self.args.exp_name, f"{self.args.eval_mode}_cnndm.jsonl")
