...
class EvalSpecBench(Decoding):
    def __init__(self, args):
        ...
        if "llama" in self.args.draft_model and "llama" in self.args.target_model:
            self.model_id = "llama"
    ...
    def load_data(self):
        ...
        self.color_print(f"Loading Specbench data...", 3)
        data = []
        with open(os.path.join(self.args.data_path, "specbench.jsonl")) as f:
    ...
    def eval(self):
        ...
        out_path = os.path.join(self.args.exp_name, f"{self.args.eval_mode}_specbench.jsonl")
