...
CUDA_VISIBLE_DEVICES=1 accelerate launch --num_processes 1 benchmark/eval_mt_bench.py --eval_mode sd --gamma 8 -n 1  -e test1 --draft_model vicuna-68m --target_model vicuna-7b --max_tokens 512 --temp 0